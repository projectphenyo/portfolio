...
const Skills = () => {
  ...
  <div className="space-y-4 relative z-10 text-black p-10 bg-white rounded-t-4xl">
    <h3 className="text-xl font-semibold border-b-4 border-yellow-500 pb-2">Frontend</h3>
    <ul className="space-y-2">
      <li className="text-muted-foreground">JavaScript</li>
  ...
  {/* Tools */}
  <div className="space-y-4 relative z-10 text-black p-10 bg-white rounded-t-4xl">
    <h3 className="text-xl font-semibold border-b-4 border-yellow-500 pb-2">Tools</h3>
    <ul className="space-y-2">
  ...
  {/* Soft Skills */}
  <div className="space-y-4 relative z-10 text-black p-10 bg-white rounded-t-4xl">
    <h3 className="text-xl font-semibold border-b-4 border-yellow-500 pb-2">Soft Skills</h3>
    <ul className="space-y-2">
      <li className="text-muted-foreground">Problem Solving</li>
      <li className="text-muted-foreground">Data Analysis</li>
      <li className="text-muted-foreground">Excel</li>
    </ul>
  </div>
</div>
</section>
